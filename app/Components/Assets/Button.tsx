...
export function Button({ children, containerClassName, className, as: Tag = "button", gradientColor, duration = 1, clockwise = true, ...props }: React.PropsWithChildren<
    {
...
>) {
    ...
    const highlight =
        `radial-gradient(75% 181.15942028985506% at 50% 50%, ${gradientColor} 0%, rgba(255, 255, 255, 0) 100%)`;
